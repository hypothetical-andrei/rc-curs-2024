...
def run():
    ...
    for i in range(101, 111):
        r1.cmd(f'ip addr add 192.168.0.{i}/24 dev r1-eth1')
    ...
    # Set up static NAT rule (10.0.0.1 -> 192.168.0.100)
    r1.cmd('iptables -t nat -A POSTROUTING -s 10.0.0.1 -o r1-eth1 -j SNAT --to-source 192.168.0.100-192.168.0.110')
    r1.cmd('iptables -A FORWARD -s 10.0.0.1 -d 192.168.0.2 -j ACCEPT')
    r1.cmd('iptables -A FORWARD -d 10.0.0.1 -s 192.168.0.2 -j ACCEPT')
